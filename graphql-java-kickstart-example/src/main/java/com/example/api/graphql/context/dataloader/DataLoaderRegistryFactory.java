...
public class DataLoaderRegistryFactory {
    ...
    public DataLoaderRegistry create() {
        ...
        registry.register(POST_DATA_LOADER, createPostDataLoader());
    ...
    private DataLoader<Long, List<Post>> createPostDataLoader() {
        return DataLoaderFactory.newMappedDataLoader(
                // return DataLoader.newMappedDataLoader(
                (Set<Long> userIds) ->
                        CompletableFuture.supplyAsync(() -> postService.getAllPostsByUserId(userIds), myExecutor)
        );
    }
